...
/* -------------------------------------------------------------------------- */
/* umf4triplet2col: reordering */
/* -------------------------------------------------------------------------- */

/* call umf4triplet2col (nrow,ncol,nz,Ti,Tj,Tv,Ap,Ai,Av,map,status) */

void umf4triplet2col_ (Int *nrow, Int *ncol, Int *nz,
               Int Ti [ ], Int Tj [ ], double Tv [ ],
               Int Ap [ ], Int Ai [ ], double Av [ ], 
               Int map [ ], Int *status)
{
    *status = UMFPACK_triplet_to_col (*nrow,*ncol,*nz,Ti,Tj,Tv,
                                      Ap, Ai, Av, map);
}
...
/* -------------------------------------------------------------------------- */
/* umf4lusize: matrix nnz sizes of LU factorization */
/* -------------------------------------------------------------------------- */
void umf4lusize_ (Int *lnz, Int *unz, Int *n_row, Int *n_col, Int *nz_udiag,
    void **Numeric)
{
    (void) UMFPACK_get_lunz (lnz,unz,n_row,n_col,nz_udiag,*Numeric);
    /*
    printf("Numeric: %d\n",*Numeric);
    printf("lunz: %d %d %d %d %d\n",*lnz,*unz,*n_row,*n_col,*nz_udiag);
    */
}
...
/* umf4lusize: matrix nnz sizes of LU factorization */
/* -------------------------------------------------------------------------- */
void umf4lusize (Int *lnz, Int *unz, Int *n_row, Int *n_col, Int *nz_udiag,
    void **Numeric)
{
    (void) UMFPACK_get_lunz (lnz,unz,n_row,n_col,nz_udiag,*Numeric);
}
