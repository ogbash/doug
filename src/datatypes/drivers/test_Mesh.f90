...
!!$  character*(*), parameter :: f_info = path//'/generated/e32x32/doug_info.dat'
!!$  character*(*), parameter :: f_elem = path//'/generated/e32x32/doug_element.dat'
!!$  character*(*), parameter :: f_coords = path//'/generated/e32x32/doug_coord.dat'
!!$  character*(*), parameter :: f_freemap = path//'/generated/e32x32/doug_freemap.dat'
!!$  character*(*), parameter :: f_system = path//'/generated/e32x32/doug_system.dat'

!!$  character*(*), parameter :: f_info = path//'/degenerate/doug_info.dat'
!!$  character*(*), parameter :: f_elem = path//'/degenerate/doug_element.dat'
!!$  character*(*), parameter :: f_coords = path//'/degenerate/doug_coord.dat'
!!$  character*(*), parameter :: f_freemap = path//'/degenerate/doug_freemap.dat'
!!$  character*(*), parameter :: f_system = path//'/degenerate/doug_system.dat'

!!$  character*(*), parameter :: f_info = path//'/poisson_2D/doug_info.dat'
!!$  character*(*), parameter :: f_elem = path//'/poisson_2D/doug_element.dat'
!!$  character*(*), parameter :: f_coords = path//'/poisson_2D/doug_coord.dat'
!!$  character*(*), parameter :: f_freemap = path//'/poisson_2D/doug_freemap.dat'
!!$  character*(*), parameter :: f_system = path//'/poisson_2D/doug_system.dat'

!!$  character*(*), parameter :: f_info = path//'/non_sym/doug_info.dat'
!!$  character*(*), parameter :: f_elem = path//'/non_sym/doug_element.dat'
!!$  character*(*), parameter :: f_coords = path//'/non_sym/doug_coord.dat'
!!$  character*(*), parameter :: f_freemap = path//'/non_sym/doug_freemap.dat'
!!$  character*(*), parameter :: f_system = path//'/non_sym/doug_system.dat'

!!$  character*(*), parameter :: f_info = home//'/e200/doug_info.dat'
!!$  character*(*), parameter :: f_elem = home//'/e200/doug_element.dat'
!!$  character*(*), parameter :: f_coords = home//'/e200/doug_coord.dat'
!!$  character*(*), parameter :: f_freemap = home//'/e200/doug_freemap.dat'
!!$  character*(*), parameter :: f_system = home//'/e200/doug_system.dat'

  ! Partitioning
  integer :: nparts = 2 ! number of parts to partition a mesh
  ...
  write(stream,*) 'Driver to test Mesh class'
 ...
 ! if (ismaster()) then
  ...
  call Mesh_readFromFile(M=Msh, fnFreelists=f_elem, fnCoords=f_coords, fnFreemap=f_freemap)
