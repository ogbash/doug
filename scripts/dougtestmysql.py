...
class DougMySQLTestResult(unittest.TestResult):
	...
	def startTest(self, test):
            ...
            self.cursor.execute("insert into testresults (testrun_ID, starttime, "
                                " method, solver, nproc) values (%s, %s, %s, %s, %s)",
                                (self.ID, datetime.today(), test.method, test.solver, test.nproc))
